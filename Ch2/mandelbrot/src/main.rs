...
/// `pixels` is a (column, row) pair indicating a particular pixel in that
...
fn pixel_to_point(
    ...
    Complex {
        ...
        // Pixel.1 increases as we go down, but the imaginary component increases as
        // we go up.
...
///
/// The `bounds` argument gives the width and height of hte buffer `pixels`,
...
fn render(
    ...
    for row in 0..bounds.1 {
        for column in 0..bounds.0 {
            ...
            // the corresponding pixel black (0). Otherwise, render assigns
            // darker colors to the numbers that took longer to escape the circle.
